...
public class EBS_Controller {
	...
	@PostMapping("/newdataprofile")
	public ResponseEntity<?> createdatabase( @RequestBody NewDatabaseProfile newdatabaseprofile){
		 BCryptPasswordEncoder passwordEncoder = new BCryptPasswordEncoder();
		    String encodedPassword = passwordEncoder.encode(newdatabaseprofile.getUserpassword());
		 NewDatabaseProfile np= service.createdatabase(newdatabaseprofile);
		return new ResponseEntity<NewDatabaseProfile>(np, HttpStatus.CREATED);
